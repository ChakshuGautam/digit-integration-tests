...
test.describe('04-citizen-timeline (#473 follow-up)', () => {
  test('PGR _search returns service.rating + workflow.action=RATE for the rated complaint', { tag: ['@area:pgr', '@ccrs:473', '@kind:regression', '@layer:api', '@persona:citizen'] }, async () => {
  ...
  test('Localization keys for the timeline rendering are seeded en_IN + sw_KE (across rainmaker-common + rainmaker-pgr)', { tag: ['@area:pgr', '@ccrs:473', '@kind:regression', '@layer:api', '@persona:citizen'] }, async () => {
